...
```{r Hourly Linear Model, message=FALSE, warning=FALSE}
#TASK C
...
```{r Fused Lasso Model, message=FALSE, warning=FALSE}
#TASK E
...
```{r Fused Lasso Model with the best lambda, message=FALSE, warning=FALSE, error=FALSE}
# Lambda = 20000000
